...
struct HelpCommand {
    ...
    func printHelp() {
        ...
        print("")
        print("romebuild --archive ProductName Revision")
        print("Archive the current project using `carthage archive` then uploads the generated archive on Rome Server")
        print("")
